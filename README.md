...
Location (GPS)
Radius (area size)
This zone is saved in the app.

Step 2 — App continuously tracks the phone's location
The app checks:
“Is the phone currently inside any saved zone?”

Step 3 — If user enters a Silent Zone → phone switches to Silent Mode
The app automatically:
Mutes ringtone
Turns vibration ON or OFF (depending on setting)
